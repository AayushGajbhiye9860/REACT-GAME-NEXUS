...
const cardData = [
  {
    color: '#060010',
    title: 'Retro Games',
    description: 'Relive the golden age of arcade gaming.',
    label: 'Collection',
  ...
  },
  {
    color: '#060010',
    title: 'Top Rated',
    description: 'The most popular games voted by gamers.',
    label: 'Popular',
  ...
  },
  {
    ...
    description: 'Play your favorite games on the go.',
    label: 'Portable',
  ...
  return (
    <section className="magic-bento-section">
      <div className="magic-bento-container">
        <h2 className="section-title-glow">Experience the Arcade</h2>
        {enableSpotlight && (
          <GlobalSpotlight
            gridRef={gridRef}
              ...
              return (
                ...
                >
                  <div className="magic-bento-card__header">
                    ...
                    {card.image && <img src={card.image} alt="" className="magic-bento-card__icon" />}
                  </div>
